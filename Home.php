...
<!--              menambahkan image brand-->
                <a class=" ms-lg-5 navbar-brand" href="#" style="color:white; font-weight: bold;"><img src="assets/images/icon-brand.png" alt="" style="width:35px">JAJAN GAME</a>
      ...
      <div class="row">
          ...
          while ($data = mysqli_fetch_array($query)) {
              ...
              <div class="col-md-2 col-sm-6 item mt-lg-5"  >
                  <div class="card item-card card-block"><a href="Pembelian.php?id=<?php echo $data['id']?>">
